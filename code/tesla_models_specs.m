...
if strcmpi(modelType,'3') && modelYear<=2023 && modelYear>=2021 && strcmpi(motorConf,'rwd')
    ...
    sepcs.epa_wh_per_km         = 146.9; % 60/437;
    sepcs.kwh_in_new_battery    = 60.5; % 61.5
    ...
    sepcs.epa_wh_per_km         = 137.8; % 60.5/439
    sepcs.epa_range             = 439; % 
    sepcs.wltp_wh_per_km      	= 123.2; % 60.5/491;
...
elseif strcmpi(modelType,'y') && modelYear>=2025 && strcmpi(motorConf,'awd')
    ...
    sepcs.rolling_res           = 0.008; %0.008 - 0.011

    sepcs.epa_wh_per_km         = 149.0; % 78.4/526.3
    sepcs.epa_range             = 526; % 78.4/526.3
    sepcs.wltp_wh_per_km      	= 133.8; % 60/437;
    sepcs.wltp_range          	= 586; % 60/437;
elseif strcmpi(modelType,'y') && modelYear>=2025 && strcmpi(motorConf,'rwd')
    ...
    sepcs.epa_wh_per_km         = 139; % 62.5/526.3
    sepcs.epa_range             = 449; % 78.4/526.3
    sepcs.wltp_wh_per_km      	= 125; % 62.5/437;
    sepcs.wltp_range          	= 500; % 62.5/437;
end
